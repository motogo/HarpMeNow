...
namespace MidiOutApi.Api {
	...
	public static class InstrumentGroupSet {
		static InstrumentGroupSet() {
            ...
            list.Add(new InstrumentGroup("Blown Bottle", Instrument.BlownBottle, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Accordion", Instrument.Accordion, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Agogo", Instrument.Agogo, Instrument.Gunshot));
            list.Add(new InstrumentGroup("OrchestralHarp", Instrument.OrchestralHarp, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Pad2Warm", Instrument.Pad2Warm, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Pad5Bowed", Instrument.Pad5Bowed, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Pad7Halo", Instrument.Pad7Halo, Instrument.Gunshot));
            list.Add(new InstrumentGroup("ReedOrgan", Instrument.ReedOrgan, Instrument.Gunshot));
            list.Add(new InstrumentGroup("ReverseCymbal", Instrument.ReverseCymbal, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Shakuhachi", Instrument.Shakuhachi, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Shamisen", Instrument.Shamisen, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Shanai", Instrument.Shanai, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Sitar", Instrument.Sitar, Instrument.Gunshot));
            list.Add(new InstrumentGroup("TangoAccordion", Instrument.TangoAccordion, Instrument.Gunshot));
            list.Add(new InstrumentGroup("Harmonica", Instrument.Harmonica, Instrument.Gunshot));
